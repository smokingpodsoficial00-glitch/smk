      ...
      >
        ...
        <nav className={`flex-1 py-4 flex flex-col gap-1.5 w-full ${sidebarCollapsed ? 'items-center px-1' : ''}`}>
          ...
          {canAccess('tarefas') && (
            ...
            >
              <CheckSquare className="size-4 shrink-0 text-emerald-400" />
              {!sidebarCollapsed && (
                <span className="truncate flex items-center gap-2">
                  Tarefas
                  <span className="text-[9px] bg-purple-500/20 text-purple-300 border border-purple-500/30 px-1.5 py-0.5 rounded-full font-bold">
                    QG
                  </span>
                </span>
              )}
